...
var twemoji = function() {
    'use strict';
    var twemoji = { base: '/static/', ext: '.png', size: '72x72', className: 'emoji', convert: { fromCodePoint: fromCodePoint, toCodePoint: toCodePoint }, onerror: function onerror() { if (this.parentNode) { this.parentNode.replaceChild(createText(this.alt, false), this); } }, parse: parse, replace: replace, test: test },
        escaper = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '\'': '&#39;', '"': '&quot;' },
